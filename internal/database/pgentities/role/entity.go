...
type Role interface {
	...
	CreateRole(ctx context.Context, id, guildId int64, name string, color int, permissions int64, hoist bool) error
	...
	SetRoleHoist(ctx context.Context, id int64, hoist bool) error
