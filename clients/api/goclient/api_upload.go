...
type ApiUploadProfileCoversUserIdBannerIdPostRequest struct {
	ctx        context.Context
	ApiService *UploadAPIService
	userId     int32
	bannerId   int32
...
// Binary image payload
func (r ApiUploadProfileCoversUserIdBannerIdPostRequest) File(file []int32) ApiUploadProfileCoversUserIdBannerIdPostRequest {
	r.file = &file
	return r
}

// Crop X coordinate in source pixels
func (r ApiUploadProfileCoversUserIdBannerIdPostRequest) CropX(cropX int32) ApiUploadProfileCoversUserIdBannerIdPostRequest {
	r.cropX = &cropX
	return r
}

// Crop Y coordinate in source pixels
func (r ApiUploadProfileCoversUserIdBannerIdPostRequest) CropY(cropY int32) ApiUploadProfileCoversUserIdBannerIdPostRequest {
	r.cropY = &cropY
	return r
}

// Crop width in source pixels
func (r ApiUploadProfileCoversUserIdBannerIdPostRequest) CropWidth(cropWidth int32) ApiUploadProfileCoversUserIdBannerIdPostRequest {
	r.cropWidth = &cropWidth
	return r
}

// Crop height in source pixels
func (r ApiUploadProfileCoversUserIdBannerIdPostRequest) CropHeight(cropHeight int32) ApiUploadProfileCoversUserIdBannerIdPostRequest {
	r.cropHeight = &cropHeight
	return r
}

func (r ApiUploadProfileCoversUserIdBannerIdPostRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.UploadProfileCoversUserIdBannerIdPostExecute(r)
}

/*
UploadProfileCoversUserIdBannerIdPost Upload user profile banner
...
Uploads a profile banner image. Requires source dimensions at least 680x240 and converts to WebP under 10MB.
	...
	@return ApiUploadProfileCoversUserIdBannerIdPostRequest
*/
func (a *UploadAPIService) UploadProfileCoversUserIdBannerIdPost(ctx context.Context, userId int32, bannerId int32) ApiUploadProfileCoversUserIdBannerIdPostRequest {
	return ApiUploadProfileCoversUserIdBannerIdPostRequest{
		ApiService: a,
		ctx:        ctx,
		userId:     userId,
...
//
//	@return string
func (a *UploadAPIService) UploadProfileCoversUserIdBannerIdPostExecute(r ApiUploadProfileCoversUserIdBannerIdPostRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UploadAPIService.UploadProfileCoversUserIdBannerIdPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/upload/profile-covers/{user_id}/{banner_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"user_id"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)
	...
	if r.cropX != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "crop_x", r.cropX, "", "")
	}
	if r.cropY != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "crop_y", r.cropY, "", "")
	}
	if r.cropWidth != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "crop_width", r.cropWidth, "", "")
	}
	if r.cropHeight != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "crop_height", r.cropHeight, "", "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{"application/octet-stream"}
