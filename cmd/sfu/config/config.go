...
type Config struct {
	...
	AuthSecret    string   `yaml:"auth_secret" env:"AUTH_SECRET" env-default:"dev-secret"`
	...
	PublicBaseURL string   `yaml:"public_base_url" env:"SFU_PUBLIC_BASE_URL" env-default:""`
	// Discovery
