...
For complete event payload schemas and examples, see [SFU Event Payloads](SFUEventPayloads.md).
...
> [!NOTE]
> For complete payload schemas, JSON examples, and code samples, see [SFU Event Payloads](SFUEventPayloads.md).
